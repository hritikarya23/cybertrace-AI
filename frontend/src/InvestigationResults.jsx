...
function InvestigationResults({ analysis, detail = null }) {
  ...
  const getHeader = (name) => detail?.headers?.find(
    (header) => header.name.toLowerCase() === name.toLowerCase()
  )?.value || "Not available";

  const returnPath = detail?.email?.return_path || getHeader("Return-Path");
  const replyTo = detail?.email?.reply_to || getHeader("Reply-To");
  const messageId = detail?.email?.message_id || getHeader("Message-ID");

  /* -----------------------------------------
     RECEIVED / ORIGIN TRACE
  ----------------------------------------- */

  const receivedHeaders = (detail?.routing?.hops || []).map(
    (hop) => hop.raw_received_header
  );
  ...
  const originIp = detail?.routing?.earliest_reliable_node?.ip || "Not detected";
        ...
        <div className="forensic-grid">
          ...
          <div className="forensic-item">
            ...
            <div>
              ...
              <strong>
                {detail?.email?.sender || "Not available"}
              </strong>
          ...
          <div className="forensic-item">
            ...
            <div>
              ...
              <strong>
                {(detail?.email?.sender || "").split("@")[1] || "Not available"}
              </strong>
          ...
          <div className="forensic-item">
            ...
            <div>
              ...
              <strong>
                {detail?.email?.subject || "Not available"}
              </strong>
          ...
          <div className="forensic-item">
            ...
            <div>
              ...
              <strong className="danger-text">
                {detail?.domains?.some((domain) => domain.is_suspicious) ? "SUSPICIOUS" : "NO ADVERSE SIGNAL"}
              </strong>
        ...
        <div className="forensic-grid">
          ...
          <div className="forensic-item">
            ...
            <div>
              ...
              <strong>
                {detail?.routing?.hops?.length ?? receivedHeaders.length}
              </strong>
